...
export const ACTIONTYPE_ACCOUNT_AUTOLOGINSUCCESS = 'ACTIONTYPE_ACCOUNT_AUTOLOGINSUCCESS';
export const ACTIONTYPE_ACCOUNT_AUTOLOGINREJECT = 'ACTIONTYPE_ACCOUNT_AUTOLOGINREJECT';
export const ACTIONTYPE_ACCOUNT_LOGINREJECT = 'ACCOUNT_LOGINREJECT';
export const ACTIONTYPE_ACCOUNT_LOGOUT = 'ACCOUNT_LOGOUT';
//帳號活動
export const ACTIONTYPE_ACCOUNT_ALLOWWEBCAM = 'ACCOUNT_ALLOWWEBCAM';
export const ACTIONTYPE_ACCOUNT_DENYWEBCAM = 'ACCOUNT_DENYWEBCAM';
...
export const ACTIONTYPE_STORY_READY = "STORY_READY"; 
export const ACTIONTYPE_STORY_UNREADY = "STORY_UNREADY";
export const ACTIONTYPE_STORY_LISTILLUSTRATIONS = "STORY_LISTILLUSTRATIONS";
export const ACTIONTYPE_STORY_RECEIVEILLUSTRATION = "STORY_RECEIVEILLUSTRATION";
//ILLUSTRATION
